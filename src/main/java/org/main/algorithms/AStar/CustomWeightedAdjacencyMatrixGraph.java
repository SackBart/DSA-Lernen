...
public class CustomWeightedAdjacencyMatrixGraph {
    private Integer[][] adjacencyMatrix = null;
    private List<NodePropertyAStar> nodeProperty = new ArrayList<>();

    public int addNode(NodePropertyAStar property) {
    ...
    public NodePropertyAStar getNodeProperty(int index) {
        for  (NodePropertyAStar node : nodeProperty) {
